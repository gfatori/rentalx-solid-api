...
categoriesRoutes.post("/", _ensureAuthenticated.ensureAuthenticated, _ensureUserIsAdmin.ensureUserIsAdmin, createCategoryController.handle);
categoriesRoutes.get("/", listCategoriesController.handle);
categoriesRoutes.post("/import", upload.single("file"), _ensureAuthenticated.ensureAuthenticated, _ensureUserIsAdmin.ensureUserIsAdmin, importCategoryController.handle);